    ...
    <>
      ...
      <main className="my-10 sm:mx-10 mx-5">
        ...
        <div className="   sm:p-10 my-10">
          ...
          <div className="grid grid-flow-col my-10 gap-5 overflow-scroll bg-slate-100 rounded-lg shadow-xl p-10 scrollbar-hide py-10  scroll-auto" id='container'>
                ...
                <div className="card carousel-item w-96 bg-base-100 shadow-md border-green-300" >
                  <div className="card-body" >
                    ...
                    <div className="grid gap-3 grid-flow-row">
                      <div className="bg-primary rounded-full w-20 h-20 overflow-hidden"><img draggable='false' src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80" className="w-full h-full object-cover" alt="" /></div>
        ...
        <div className="rounded-xl">
          ...
          <div className="flex overflow-scroll  scrollbar-hide py-10 gap-5 scroll-auto" id='container'>
            {courses.map((course) => {
              return <>
                <div className="grid gap-10 sm:flex justify-center item" key={course.id}>
                  <div className="card w-60 sm:w-96 bg-base-100 shadow-xl">
                    <figure className="px-10 pt-10">
                      <div className="rounded-2xl overflow-hidden "><img draggable='false' src="https://www.choomcham.com/assets/images/84dfa30d.png" alt="course one" className="hover:saturate-50 rounded-2xl hover:scale-110 duration-150" /></div>
                    </figure>
                    <div className="card-body ">
        ...
        <div className="mt-10">
          ...
          <div className="grid gap-10 sm:flex justify-center" id='container'>
            {consults.map((consult) => {
              return <>
                <div className=" w-96 grid justify-center justify-items-center text-center item" key={consult.id} >
                  <figure className="px-10 pt-10 pb-5">
                    <div className="rounded-full w-48 h-48 overflow-hidden drop-shadow-xl"><img draggable='false' src="https://images.unsplash.com/photo-1488161628813-04466f872be2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1964&q=80  " alt="course one" className="w-full" /></div>
                  </figure>
                  <div className="">
              ...
              return (
                <>
                  <motion.div initial={{ y: 20, opacity: 0 }}
                    ...
                    <figure className="rounded-xl overflow-hidden"><img draggable='false' className="rounded-xl" src="https://www.choomcham.com/assets/images/84dfa30d.png" alt="Shoes" /></figure>
                    <div className="card-body">
      ...
      <Script src="/js/dragtoscroll.js" strategy="lazyOnload"/>
      <Footer />
    </>
  )
}
